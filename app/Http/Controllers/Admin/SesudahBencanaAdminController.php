...
class SesudahBencanaAdminController extends Controller
{
    /**
    ...
    public function index()
    {
        ...
        // dd($riwayats);
        return view('admin.sesudah_bencana.index', compact( 'riwayats'));
    }
    ...
    public function show($group_id)
    {
        ...
        // dd($respons);
        return view('admin.sesudah_bencana.detail', compact('respons'));
    }
