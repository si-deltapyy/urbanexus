...
class TerjadiBencanaRtController extends Controller
{
    /**
    ...
    public function index()
    {
        ...
        // dd($riwayats);
        return view('user.rt.terjadi_bencana.index', compact( 'rt', 'riwayats'));
    }
    ...
    public function create()
    {
        ...
        return view('user.rt.terjadi_bencana.create', compact('pertanyaans', 'user', 'data', 'rt'));
    }
    ...
    public function store(Request $request)
    {
        ...
        return redirect()->route('rt.kuisioner_tb.index');
    }
    ...
    public function show($group_id)
    {
        ...
        // dd($respons);
        return view('user.rt.terjadi_bencana.detail', compact('user', 'data', 'respons', 'rt'));
    }
