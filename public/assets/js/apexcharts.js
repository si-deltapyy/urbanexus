...
$(function () {
    ...
    if ($("#apexLine").length) {
        ...
        var apexLineChart = new ApexCharts(
            document.querySelector("#apexLine"),
            lineChartOptions
        );
    ...
    if ($("#apexBar").length) {
        ...
        var apexBarChart = new ApexCharts(
            document.querySelector("#apexBar"),
            options
        );
        apexBarChart.render();
    }
    ...
    if ($("#apexArea").length) {
        ...
        var chart = new ApexCharts(
            document.querySelector("#apexArea"),
            options
        );
        chart.render();
    ...
    if ($("#apexDonut").length) {
        ...
        var chart = new ApexCharts(
            document.querySelector("#apexDonut"),
            options
        );
        chart.render();
    }
    ...
    if ($("#apexRadialBar").length) {
        ...
        var chart = new ApexCharts(
            document.querySelector("#apexRadialBar"),
            options
        );
        chart.render();
        var chartAreaBounds = chart.w.globals.dom.baseEl
