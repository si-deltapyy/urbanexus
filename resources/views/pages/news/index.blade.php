                ...
                <div class="card">
                    <div class="card-body">
                        <div class="d-flex justify-content-between">
                            <a class="btn btn-primary btn-md-12 mb-3" href="{{ route('admin.news.create') }}">
                                ...
                                <tbody>
                                    ...
                                    @foreach ($news as $n)
                                        <tr>
                                            ...
                                            <td class="text-wrap">{{ $n->author }}</td>
                                            <td class="text-wrap">{{ $n->content }}</td>
                                            <td class="text-wrap">
                                            @if ($n->image_path)
                                                <img src="{{ asset($n->image_path) }}" alt="News Image" width="100">
                                            @else
                                                No Image
                                            @endif
                                            </td>
