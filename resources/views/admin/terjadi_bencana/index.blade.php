...
@section('content')
    <nav class="page-breadcrumb">
        <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item active" aria-current="page">Terjadi Bencana</li>
        </ol>
    </nav>
            ...
            <div class="card">
                <div class="card-body">
                    <div class="d-flex justify-content-end">
                        <a href="{{ route('admin.terjadi_bencana_pdf') }}" class="btn btn-primary">Unduh PDF</a>
                    </div>
                                            ...
                                            <td style="display: flex; gap: 1rem;">
                                                @role('super_admin')
                                                    <a class="btn icon btn-sm btn-primary"
                                                        href="{{ route('super_admin.kuisioner_tb.show', $riwayat->group_id) }}"
                                                        title="Detail">
                                                        <i data-feather="eye"></i>
                                                    </a>
                                                    <form class=" hover:bg-red-900 text-white rounded-md" method="POST"
                                                        action="{{ route('super_admin.kuisioner_tb.destroy', $riwayat->group_id) }}"
