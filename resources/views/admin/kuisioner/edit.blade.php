            ...
            <div class="card">
                <div class="card-body">
                    ...
                    <form class="form form-horizontal needs-validation" novalidate method="POST"
                        enctype="multipart/form-data" action="{{ route('admin.pertanyaan.update', $pertanyaan->id) }}">
                        @csrf
                        @method('PUT')
                        <div class="form-body">
                            <div class="row">
                                <div class="row mt-3">
                                    ...
                                    <div class="col-md-8 form-group">
                                        <select class="form-select @error('kategori_pertanyaan') is-invalid @enderror"
                                            ...
                                            <option value="{{ old('kategori_pertanyaan', $pertanyaan->kategori_pertanyaan) }}">
                                                {{ $pertanyaan->kategori_pertanyaan }}</option>
                                ...
                                <div class="row mt-3">
                                    ...
                                    <div class="col-md-8 form-group">
                                        <input type="text" class="form-control @error('pertanyaan') is-invalid @enderror"
                                            id="pertanyaan" name="pertanyaan" value="{{ old('pertanyaan', $pertanyaan->pertanyaan) }}" required>
                                        @error('pertanyaan')
                                ...
                                <div class="row mt-3">
                                    ...
                                    <div class="col-md-8 form-group">
                                        <select class="form-select @error('jenis_pertanyaan') is-invalid @enderror"
                                            ...
                                            <option value="{{ old('jenis_pertanyaan', $pertanyaan->jenis_pertanyaan) }}">
                                                {{ $pertanyaan->jenis_pertanyaan }}</option>
